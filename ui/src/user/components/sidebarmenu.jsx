...
//             ? "text-white"
//             : theme
//                 ? "text-white"   // dark mövzu → ağ
//                 : "text-[#1D1D1B]"; // light mövzu → qara
//     return (
//         <>
//             <button onClick={() => setOpen(true)} className="ml-[30px] cursor-pointer">
//                 <RxHamburgerMenu
//                     className={`text-[20px] mt-[5px] transition-colors duration-300 ${hamburgerColor}`}
//                 />
//             </button>
//             <div
//                 className={`
//           fixed top-0 left-0 h-full bg-white text-black z-50
//           transition-all duration-300 ease-in-out
//           ${theme ? "bg-dark" : "bg-light"}
//           ${open ? "translate-x-0" : "-translate-x-full"}
//           ${active ? "w-[700px]" : "w-[350px]"}
//         `}
//             >
...
//                     <ul
//                         className={` w-[350px] p-6 space-y-4  ${active ? "border-r border-gray-300 dark:border-gray-700" : ""}`}
//                     >
//                         <li
//                             className="cursor-pointer hover:underline text-[18px] flex justify-between items-center"
//                             onClick={() => setActive("furniture")}
//                         >
//                             Furniture  <IoIosArrowForward className="text-lg" />
//                         </li>


//                         <li className="cursor-pointer hover:underline text-[18px]"
...
//                             Blog
//                         </li>
//                         <li className="cursor-pointer hover:underline text-[18px] flex justify-between items-center"
//                             onClick={() => setActive("service")}>
//                             Customer Service  <IoIosArrowForward className="text-lg" />
//                         </li>
...
//                     </ul>
//                     {active && (
//                         <div className="w-1/2 p-6 h-[400px]">

//                             <button
//                                 className="mb-4  hover:underline  flex items-center gap-4"
//                                 onClick={() => setActive(null)}
//                             >
//                                 <IoIosArrowBack className="text-lg cursor-pointer" /> Back
//                             </button>
...
//                                 {active === "furniture" && <Verticalslider items={items} slidesPerView={3} height="500px" onItemClick={(item) => { navigate(item.path); setOpen(false); setActive(null); }}
//                                 />}

//                                 {active === "service" && (
//                                     <>
//                                         <li className="cursor-pointer hover:underline" onClick={() => { navigate("/contact"); setOpen(false); setActive(null); }}
//                                         >Contact</li>
//                                         <li className="cursor-pointer hover:underline" onClick={() => { navigate("/delivery"); setOpen(false); setActive(null); }}
//                                         >Delivery</li>
//                                         <li className="cursor-pointer hover:underline" onClick={() => { navigate("/productcare"); setOpen(false); setActive(null); }}
//                                         >Product care</li>
                        ...
                        `}>
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                {active === "furniture" && (
                                    <Verticalslider 
                                        items={items} 
                                        slidesPerView={window.innerWidth < 640 ? 2 : window.innerWidth < 768 ? 2 : 3} 

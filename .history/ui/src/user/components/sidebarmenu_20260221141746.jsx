                ...
                <div className="flex flex-col md:flex-row h-full">
                    ...
                    {!active && (
                        <div className="flex flex-col gap-4 p-4 border-t mt-4 md:hidden">
                            ...
                            {bool ? (
                                <NavLink className="text-sm cursor-pointer text-[#1D1D1B]" to="/login" onClick={logOut}>
                                    Logout
                                </NavLink>
                            ) : (
                                <NavLink to="/login">
                                    <FaUserCircle className={`w-5 h-5 cursor-pointer ${theme ? "text-gray-200" : "text-[#1D1D1B]"}`} />
                                </NavLink>
                            )}
                            <span className="cursor-pointer" onClick={changeTheme}>
                                {theme ? <FaMoon size={18} /> : <FaSun size={18} />}

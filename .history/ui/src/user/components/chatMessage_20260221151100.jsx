...
function ChatMessage() {
    ...
    {
        id: 'DeliveryQ1',
        message: When would you like the delivery to be?,
        trigger: 'DeliveryA1',
    },
    {
        id: 'DeliveryA1',
    ...
    {
        id: 'DeliveryQ2',
        message: 'Standard delivery takes 3-5 business days. Is your address correct?',
        trigger: 'DeliveryA2',
    },
    {
        id: 'DeliveryA2',
    ...
    {
        id: 'DeliveryEnd',
        message: 'Thank you! If you have any other questions, please contact us.',
        end: true,
    },
    ...
    {
        id: 'ServiceQ1',
        message: 'What is the issue with your product?',
        trigger: 'ServiceA1',
    },
    {
        id: 'ServiceA1',
    ...
    {
        id: 'ServiceQ2',
        message: 'How many days ago did you purchase the product?',
        trigger: 'ServiceA2',
    },
    {
        id: 'ServiceA2',
    ...
    {
        id: 'ServiceEnd',
        message: 'Got it! Our specialist will contact you shortly.',
        end: true,
    },
];
    const chatMessage = () => {

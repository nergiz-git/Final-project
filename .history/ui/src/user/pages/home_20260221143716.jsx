    ...
    <div className={`w-full ${theme ? "bg-dark" : "bg-light"}`}>
      ...
      <div className="relative w-full h-[400px] sm:h-[500px] md:h-[600px] aspect-[16/9] overflow-hidden">
        <video className="absolute inset-0 w-full h-full object-cover" autoPlay muted loop playsInline>
          <source src="https://cdn.static.amplience.net/boconcept/_vid/a3bc902a-c3ac-4d31-a2c1-b39f00bcdfe9/df633158-c5c7-4555-9920-508d6f3530a9/video/2927832f-c6b9-400b-b0fe-c0205dc8f255.webm" type="video/mp4" />
        </video>

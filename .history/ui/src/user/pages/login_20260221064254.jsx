...
function Sign() {
    ...
    const addUser = (e) => {
        ...
        // Əgər bütün sahələr doldurulmayıbsa, dayandır
        ...
        if (!checkPassword(user.pass)) {
            setShowPasswordRules(true);  // Qaydaları göstər
            setPasswordValid(false);      // Valid deyilsə false
            return;  // Heç bir fetch çağırışı olmur
        }

        // Əgər buraya gəldikdə, şifrə düzgündür → POST et
        fetch("http://localhost:3002/users", {
            method: "POST",

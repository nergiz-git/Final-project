            ...
            <div className="max-w-7xl mx-auto p-6 mt-[260px] relative">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="lg:w-[400px] space-y-6">
                        ...
                        <button className="w-full bg-black text-white hover:bg-white hover:text-black py-3 rounded-lg">
                            Add to cart
                        </button>
                        <button className="w-full bg-black text-white hover:bg-white hover:text-black hover:border hover:border-blac py-3 rounded-lg">
                            Add to fav
                        </button>
